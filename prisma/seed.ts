...
async function main() {
  ...
  const rotationRulesData = [
    ...
    // Generalizations
    { kode_tanaman_sebelum: 'T001', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Bawang Merah dirotasikan dengan Legum untuk memulihkan kesuburan tanah', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T001', famili_target: 'Solanaceae', alasan_agronomis: 'Inferensi famili: Bawang Merah dirotasikan dengan Solanaceae untuk memutus siklus patogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T002', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Bawang Putih dirotasikan dengan Legum untuk memulihkan kesuburan tanah', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T002', famili_target: 'Solanaceae', alasan_agronomis: 'Inferensi famili: Bawang Putih dirotasikan dengan Solanaceae untuk memutus siklus patogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T003', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Brokoli (Brassicaceae) dirotasikan ke Legum untuk memutus siklus hama', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T004', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Gandum (Poaceae) dirotasikan ke Legum untuk pengisian unsur nitrogen tanah', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T005', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Tanaman umbi dirotasikan ke Legum untuk memulihkan tanah', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T006', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Tanaman umbi dirotasikan ke Legum untuk memulihkan tanah', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T007', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Blewah dirotasikan ke Legum untuk memutus siklus hama dan mengisi nitrogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T008', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Tomat dirotasikan ke Legum untuk memutus siklus hama dan mengisi nitrogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T013', famili_target: 'Poaceae', alasan_agronomis: 'Inferensi famili: Legum (Kacang Arab) dirotasikan ke Poaceae untuk memanfaatkan nitrogen sisa', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T013', famili_target: 'Solanaceae', alasan_agronomis: 'Inferensi famili: Legum (Kacang Arab) dirotasikan ke Solanaceae untuk memanfaatkan nitrogen sisa', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T018', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Kentang (Solanaceae) dirotasikan ke Legum untuk memutus siklus hama', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T023', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Nanas dirotasikan ke Legum (umum berlaku secara agronomis)', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T024', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Padi Gogo (Poaceae) dirotasikan ke Legum untuk memulihkan aerasi dan nitrogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T027', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Pare (Cucurbitaceae) dirotasikan ke Legum untuk memutus siklus patogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T028', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Semangka (Cucurbitaceae) dirotasikan ke Legum untuk memutus siklus patogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T029', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Sorgum (Poaceae) dirotasikan ke Legum untuk mengembalikan nitrogen', sumber: 'generalisasi_famili' as const },
    { kode_tanaman_sebelum: 'T030', famili_target: 'Fabaceae', alasan_agronomis: 'Inferensi famili: Talas dirotasikan ke Legum untuk memulihkan hara', sumber: 'generalisasi_famili' as const },
  ];
